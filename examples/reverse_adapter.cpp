...
namespace adapter_test {
    ...
    //--------------------------------------------------------------------------
    //--------------------------------------------------------------------------
    reverse_adapter::reverse_adapter (iomultiplex::connection& conn, bool close_on_destruct)
    ...
    //--------------------------------------------------------------------------
    //--------------------------------------------------------------------------
    reverse_adapter::reverse_adapter (std::shared_ptr<iomultiplex::connection> conn_ptr)
    ...
    //--------------------------------------------------------------------------
    //--------------------------------------------------------------------------
    ssize_t reverse_adapter::do_read (void* buf, size_t size, int& errnum)
    {
    ...
    //--------------------------------------------------------------------------
    //--------------------------------------------------------------------------
    ssize_t reverse_adapter::do_write (const void* buf, size_t size, int& errnum)
    {
        if (size > wbuf_size) {

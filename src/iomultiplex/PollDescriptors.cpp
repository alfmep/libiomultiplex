...
namespace iomultiplex {
    ...
    //--------------------------------------------------------------------------
    //--------------------------------------------------------------------------
    bool PollDescriptors::activate (int fd, short events, bool merge)
    {
        // Sanity check
        if (fd < 0)
            return false;
    ...
    //--------------------------------------------------------------------------
    //--------------------------------------------------------------------------
    bool PollDescriptors::deactivate (int fd, short events)
    {
        // Sanity check
    ...
    //--------------------------------------------------------------------------
    //--------------------------------------------------------------------------
    void PollDescriptors::schedule_activate (int fd, short events, bool merge)
    {
    ...
    //--------------------------------------------------------------------------
    //--------------------------------------------------------------------------
    void PollDescriptors::schedule_deactivate (int fd, short events)
    {

 ...
 */
#include <iomultiplex/chunk_adapter.hpp>
...
namespace iomultiplex {
    ...
    //--------------------------------------------------------------------------
    //--------------------------------------------------------------------------
    bool chunk_adapter::chunk_rx_cb (io_result_t& ior,
    ...
    //--------------------------------------------------------------------------
    //--------------------------------------------------------------------------
    chunk_adapter::chunk_adapter (connection& conn, bool close_on_destruct)
    ...
    //--------------------------------------------------------------------------
    //--------------------------------------------------------------------------
    chunk_adapter::chunk_adapter (std::shared_ptr<connection> conn_ptr)
        : adapter (conn_ptr),
          rx_buf_size (0),
          tx_buf_size (0),
          rx_buf_pos  (0),
    ...
    // Async read
    //--------------------------------------------------------------------------
    int chunk_adapter::read (void* buf,
                             size_t chunk_size,
                             size_t num_chunks,
                             io_callback_t rx_cb,
                             unsigned timeout)
    ...
    // Sync read
    //--------------------------------------------------------------------------
    ssize_t chunk_adapter::read (void* buf,
                                 size_t chunk_size,
                                 size_t num_chunks,
                                 unsigned timeout)
    {
    ...
    //--------------------------------------------------------------------------
    //--------------------------------------------------------------------------
    bool chunk_adapter::chunk_tx_cb (io_result_t& ior,
    ...
    // Async write
    //--------------------------------------------------------------------------
    int chunk_adapter::write (const void* buf,
                              size_t chunk_size,
                              size_t num_chunks,
                              io_callback_t tx_cb,
                              unsigned timeout)
    ...
    // Sync write
    //--------------------------------------------------------------------------
    ssize_t chunk_adapter::write (const void* buf,
                                  size_t chunk_size,
                                  size_t num_chunks,
                                  unsigned timeout)
    {
    ...
    //--------------------------------------------------------------------------
    //--------------------------------------------------------------------------
    void chunk_adapter::cancel (bool cancel_rx,
                                bool cancel_tx,
                                bool fast)
    {
        if (cancel_rx) {

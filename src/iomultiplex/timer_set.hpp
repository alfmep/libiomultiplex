 ...
 */
#ifndef IOMULTIPLEX_TIMER_SET_HPP
#define IOMULTIPLEX_TIMER_SET_HPP
...
namespace iomultiplex {
    ...
    public:
         ...
         * @param ts The timer_set object owning the timer.
         ...
         */
        using cb_t = std::function<void(timer_set& ts, long timer_id)>;

        /**
         * Constructor.
         * @param ioh An iohandler_base object.
         */
        timer_set (iohandler_base& ioh);

        /**
         * Move constructor.
         * @param ts The timer_set object to move.
         */
        timer_set (timer_set&& ts);
        ...
        /**
         * Move operator.
         * @param rhs The timer_set object to move.
         * @return A reference to this object.
         */
        timer_set& operator= (timer_set&& rhs);
         ...
         *               or the timer_set object is destroyed.
         *               <br/>

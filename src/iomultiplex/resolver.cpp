...
namespace iomultiplex {
    ...
    //--------------------------------------------------------------------------
    //--------------------------------------------------------------------------
    std::vector<ip_addr> resolver::lookup_srv (const std::string& domain,
                                               const std::string& proto,
                                               const std::string& service,
                                               bool dns_fallback)
    {
        std::vector<ip_addr> addr_list;
        ...
        for (auto srv_rec : srv_records) {
            ...
            std::vector<ip_addr> addresses = lookup_host (srv_rec.target, srv_rec.port);
    ...
    //--------------------------------------------------------------------------
    //--------------------------------------------------------------------------
    std::vector<ip_addr> resolver::lookup_host (const std::string& hostname,
                                                const uint16_t port)
    {
        std::vector<ip_addr> addr_list;

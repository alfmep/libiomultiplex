 ...
 */
#ifndef IOMULTIPLEX_CHUNK_ADAPTER_HPP
#define IOMULTIPLEX_CHUNK_ADAPTER_HPP
...
namespace iomultiplex {
     ...
     */
    class chunk_adapter : public adapter {
    public:
        /**
         * Default constructor.
         ...
         *                          open.
         */
        chunk_adapter (connection& conn, bool close_on_destruct=false);
         ...
         */
        chunk_adapter (std::shared_ptr<connection> conn_ptr);

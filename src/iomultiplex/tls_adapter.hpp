 ...
 */
#ifndef IOMULTIPLEX_TLSAD_APTER_HPP
#define IOMULTIPLEX_TLSAD_APTER_HPP

#include <iomultiplex/adapter.hpp>
#include <iomultiplex/connection.hpp>
#include <iomultiplex/tls_config.hpp>
...
namespace iomultiplex {
     ...
     */
    class tls_adapter : public adapter {
    public:
        /**
         * Callback that is called when a TLS handshake is finished (successful or not).
         * @param tls The tls_adapter instance that attempted to establish a secure connection.
         * @param errnum The value of <code>errno</code>.
         */
        using tls_handshake_cb_t = std::function<void (tls_adapter& tls, int errnum)>;
         ...
         *                          open.
         */
        tls_adapter (connection& conn, bool close_on_destruct=false);
         ...
         */
        tls_adapter (std::shared_ptr<connection> conn_ptr);
         ...
         */
        int start_tls (const tls_config& tls_config,
                       bool is_server,
                       bool use_dtls,
                       void* buf,
                       size_t buf_len,
         ...
         * @return 0 on success. -1 on error and <code>errno</code> is set.
         */
        inline int start_tls (const tls_config& tls_config,
                              bool is_server,
                              bool use_dtls,
                              tls_handshake_cb_t callback,
                              unsigned timeout=-1)
         ...
         * @return 0 on success. -1 on error and <code>errno</code> is set.
         */
        inline int start_server_tls (const tls_config& tls_config,
                                     tls_handshake_cb_t callback,
                                     unsigned timeout=-1)
        {
         ...
         * @return 0 on success. -1 on error and <code>errno</code> is set.
         */
        inline int start_server_tls (const tls_config& tls_config, unsigned timeout=-1)
        {
         ...
         * @return 0 on success. -1 on error and <code>errno</code> is set.
         */
        inline int start_client_tls (const tls_config& tls_config,
                                     tls_handshake_cb_t callback,
                                     unsigned timeout=-1)
        {
         ...
         * @return 0 on success. -1 on error and <code>errno</code> is set.
         */
        inline int start_client_tls (const tls_config& tls_config, unsigned timeout=-1)
        {
         ...
         * @return 0 on success. -1 on error and <code>errno</code> is set.
         */
        inline int start_server_dtls (const tls_config& tls_config,
                                      tls_handshake_cb_t callback,
                                      unsigned timeout=-1)
        {
         ...
         * @return 0 on success. -1 on error and <code>errno</code> is set.
         */
        inline int start_server_dtls (const tls_config& tls_config, unsigned timeout=-1)
        {
         ...
         * @return 0 on success. -1 on error and <code>errno</code> is set.
         */
        inline int start_client_dtls (const tls_config& tls_config,
                                      tls_handshake_cb_t callback,
                                      unsigned timeout=-1)
        {
         ...
         * @return 0 on success. -1 on error and <code>errno</code> is set.
         */
        inline int start_client_dtls (const tls_config& tls_config, unsigned timeout=-1)
        {
